<template>
  <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 500 500" width="500" height="500">
        <!-- white circle -->
    <path d="M274.97 10.55c122.41 0 221.83 84.63 221.83 188.84 0 104.24-99.42 188.83-221.83 188.83-122.45 0-221.87-84.59-221.87-188.83 0-104.21 99.42-188.84 221.87-188.84z" id="a" fill="#fff" stroke="#000" stroke-width="1.5"/>
    <!-- black circle -->
    <path d="M397.28 42.5c69.48 59.24 57.7 165.46-26.28 237.05-83.97 71.6-208.61 81.64-278.09 22.4C23.42 242.71 35.2 136.5 119.2 64.93c84-71.63 208.59-81.66 278.08-22.43z" id="b" fill="#020202"/>
    <!-- stars group -->
    <g fill="#fff" stroke="#000" >
      <!-- right star -->
      <path d="M280.3 82.96l-25.49 21.98-35.62-5.76 16.57 27.83-17.14 27.34 35.75-4.78 25.01 22.66 5.53-30.78 32.6-13.35-32.31-14.21-4.9-30.93z" id="c" stroke-opacity="0" />
      <!-- left star -->
