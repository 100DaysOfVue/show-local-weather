<template>
  <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 333 333" width="333px" height="333px">
    <!-- yellow circle -->
    <path d="M247.05 166.73c0 44.64-36.16 80.88-80.7 80.88-44.54 0-80.7-36.24-80.7-80.88 0-44.65 36.16-80.89 80.7-80.89 44.54 0 80.7 36.24 80.7 80.89z" id="a" fill="#ffcb00" stroke="#000" stroke-width="1.5" />
